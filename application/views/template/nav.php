...
<head>
    ...
    <title>E-Pens - Belajar Dimana Saja & Kapan Saja !</title>
    <!-- Bootstrap CSS -->
            ...
            <div class="container">
                <div class="float-left">
                    <ul class="list header_social">
                        <li><a href="https://www.facebook.com/muhammmadzaid"><i class="fa fa-facebook"></i></a></li>
                        <li><a href="https://twitter.com/zaidabdillah"><i class="fa fa-twitter"></i></a></li>
                       <li><a href="https://www.github.com/zaidabdillah18"><i class="fa fa-github"></i></a></li>
                        <li><a href="https://www.instagram.com/zaidabdillah20"><i class="fa fa-instagram"></i></a></li>
                    </ul>
                </div>
                <div class="float-right">
                    <a class="dn_btn" href="#">Zaidabdillah18@gmail.com</a>
                </div>
            </div>
        </div>
        ...
        <div class="main_menu">
            <nav class="navbar navbar-expand-lg navbar-light">
                <div class="container">
                    ...
                    <a href="<?= base_url('welcome') ?>" style="font-size: 30px;font-weight:900;font-family: 'Poppins', sans-serif;" class="text-success text-center"><img src="<?= base_url('assets/') ?>img/favicon.png" alt="">
                                E-Pens </a>
