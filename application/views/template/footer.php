    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-2  col-md-6 col-sm-6">
                <div class="single-footer-widget tp_widgets">
                    ...
                    <ul class="list">
                        <li><a href="<?= base_url('welcome/tentang') ?>">Tentang E-Pens</a></li>
                        <li><a href="<?= base_url('welcome/materi') ?>">Materi E-Pens</a></li>
                        <li><a href="<?= base_url('welcome/kontak') ?>">Kontak E-Pens</a></li>
                        <li><a href="http://pens.ac.id/">Website Resmi Pens</a></li>
                    </ul>
                </div>
            </div>
            <div class="col-lg-2  col-md-6 col-sm-6">
                <div class="single-footer-widget tp_widgets">
                    ...
                    <ul class="list">
                        ...
                        <li><a href="<?= base_url('welcome/guru') ?>">Untuk Dosen</a></li>
                    </ul>
                </div>
            </div>
            <div class="col-lg-2  col-md-6 col-sm-6">
                <div class="single-footer-widget tp_widgets">
                    ...
                    <ul class="list">
                        <li><a href="javaScript:void(0);">Organisasi Komputer</a></li>
                        <li><a href="javaScript:void(0);">Logika Algoritma</a></li>
                        <li><a href="javaScript:void(0);">Workshop Desain Web</a></li>
                        <li><a href="javaScript:void(0);">Konsep Pemograman</a></li>
                        <li><a href="javaScript:void(0);">Matematika Diskrit</a></li>
                        <li><a href="javaScript:void(0);">Basis Data</a></li>
                        <li><a href="javaScript:void(0);">Matematika 1</a></li>
                    </ul>
                </div>
            </div>
            <div class="col-lg-2  col-md-6 col-sm-6">
            ...
            <div class="col-lg-4 col-md-6 col-sm-6">
                <h4 class="footer_title">Tentang E-Pens</h4>
                <p>
                    Web Edukasi Open Source yang dibuat oleh zaidabdillah.  E-Pens adalah Web edukasi yang dilengkapi video, materi, pengumpulan tugas dan sistem ujian yang tersedia secara gratis. E-Pens dibuat ditujukan agar para Mahasiswa dan Dosen dapat terus belajar dan mengajar dimana saja dan kapan saja.
                </p>
            </div>
        </div>
        <div class="row footer-bottom d-flex justify-content-between align-items-center">
            <p class="col-lg-8 col-md-8 footer-text m-0">
                ...
                <a href="https://colorlib.com" target="_blank">Colorlib</a> <br> E-Pens is made with <span class="text-danger"> &#10084;</span> by <a href="https://github.com/zaidabdillah18">Zaidabdillah </a> with MIT License
                <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
            </p>
