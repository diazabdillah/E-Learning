...
<head>
    <meta charset="utf-8" />
    <title>E-Learning Pens - Data Materi</title>
                    ...
                    <div class="main-content">
                        <section class="section">
                            <div class="card" style="width:100%;">
                                <div class="card-body">
                                    <h2 class="card-title" style="color: black;">Data Materi E-Pens</h2>
                                    <hr>
                                    <a href="<?= base_url('guru/add_materi') ?>" class="btn btn-success">Tambah
                                        Data Materi</a>
                                </div>
                            </div>
                            <div class="row">
                                            ...
                                            ?>
                                                    <tr class="text-center">
                                                        ...
                                                        <td class="text-center">
                                                            <a href="<?php echo site_url('guru/update_materi/' . $u->id); ?>"
                                                                class="btn btn-info">Update ⭢</a>

                                                            <a href="<?php echo site_url('guru/delete_materi/' . $u->id); ?>"
