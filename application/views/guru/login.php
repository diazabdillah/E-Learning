...
<head>
    ...
    <title>E-Pens - Teacher Login</title>
                ...
                <div class="col-lg-4 col-md-6 col-12 order-lg-1 min-vh-100 order-2 bg-white">
                    <div class="p-4 m-3">
                        <a href="#" style="font-size: 30px;font-weight:900;font-family: 'Poppins', sans-serif;"
                            class="text-success text-center"><img src="<?= base_url('assets/') ?>img/favicon.png"
                                alt="">
                            E-Pens </a>
                        <br>
                        <br>
                        <h4 class="text-dark font-weight-normal">Selamat datang di <span
                                class="font-weight-bold">E-Pens</span>
                        </h4>
                        <p class="text-muted">Sebelum masuk ke halaman Dosen, anda harus login terlebih dahulu sebagai
                            Dosen. silahkan isi data dibawah untuk melanjutkan.</p>
                ...
                <div class="col-lg-8 col-12 order-lg-2 order-1 min-vh-100 background-walk-y position-relative overlay-gradient-bottom"
                    ...
                    <div class="absolute-bottom-left index-2">
                        <div class="text-light p-5 pb-2">
                            <div class="mb-5 pb-3">
                                <h1 class="mb-2 display-4 font-weight-bold text-white">Selamat datang, Dosen!</h1>
                            ...
                            Made with <span class="text-danger"> &#10084;</span> by <a class="text-light bb"
                                target="_blank" href="https://zaidabdillah20.github.io/">zaidabdillah</a> - Image by <a
