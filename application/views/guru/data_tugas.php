...
<head>
    <meta charset="utf-8" />
    <title>E-Pens - Tambah Materi</title>
                    ...
                    <div class="main-content">
                        <section class="section">
                            <div class="card" style="width:100%;">
                                <div class="card-body">
                                    <h2 class="card-title" style="color: black;">Data Tugas E-Pens</h2>
                                    <hr>
                                    <a href="<?= base_url('guru/add_tugas') ?>" class="btn btn-success">Tambah
                                        Data Tugas</a>
                                </div>
                            </div>
                            <div class="row">
                                        ...
                                        <div class="table-responsive">
                                            <table id="example" class="table align-items-center table-flush">
                                                <thead class="thead-light">
                                                    <tr class="text-center">
                                                        ...
                                                        <th scope="col">Judul Matakuliah</th>
                                                        <th scope="col">Deskripsi</th>
                                                        <th scope="col">Tanggal Pembuatan</th>
                                                        <th scope="col">Tanggal Pengumpulan Tugas</th>
                                            ...
                                            ?>
                                                    <tr class="text-center">
                                                        ...
                                                        <td>
                                                            <?= substr($tugas->deskripsi, 0, 30); ?>

                                                        </td>
                                                        <td>
                                                            <?php echo $tugas->tanggal_buat ?>

                                                        </td>
                                                        <td>
                                                            <?php echo $tugas->tanggal_kumpul ?>
                                                        ...
                                                        <td class="text-center">
                                                            <a href="<?php echo site_url('guru/update_tugas/' . $tugas->id); ?>"
                                                                class="btn btn-info">Update ⭢</a>

                                                            <a href="<?php echo site_url('guru/delete_tugas/' . $tugas->id); ?>"
