                        ...
                        <div class="row">
                            <div class="col-md-12 bg-white p-4 container"
                                ...
                                <form method="post" enctype="multipart/form-data"
                                    action="<?=base_url('guru/add_tugas')?>">
...
echo $data['user']['nama_mapel'];?>" class="form-control" id="inputEmail4">
                                    ...
                                    <div class="form-group">
                                        <label for="exampleFormControlTextarea1">Judul Materi</label>
                                        <input class="form-control" required name="judul"
                                    ...
                                    <div class="form-group">
                                        <label for="exampleFormControlTextarea1">Tanggal Kumpul</label>
                                        <input type="date" class="form-control" required name="tanggal_kumpul"
                                            id="exampleFormControlTextarea1" rows="3">

                                    </div>

                                    <div class="form-group">
                                        <label for="exampleFormControlTextarea1">Tanggal Buat</label>
                                        <input type="date" class="form-control" required name="tanggal_buat"
                                            id="exampleFormControlTextarea1" rows="3">
