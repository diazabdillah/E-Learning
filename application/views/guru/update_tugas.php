                        ...
                        <section class="section">
                            <div class="">
                                <div class="card" style="width:100%;">
                                    <div class="card-body">
                                        <h2 class="card-title" style="color: black;">Update Data Tugas</h2>
                                        <hr>
                            ...
                            <div class="card card-success">
                                <div class="col-md-12 text-center">
                                    ...
                                    <p style="line-height:-30px;margin-top:-20px;">Silahkan isi data data yang
                                        diperlukan
                                        dibawah </p>
                                    <hr>
                                </div>
                                ...
                                <div class="card-body">
                                    <form method="POST" action="<?= base_url('guru/tugas_edit') ?>">
