...
<head>
    <meta charset="utf-8" />
    <title>E-Learning Pens - Teacher Page</title>
                ...
                <div class="kt-aside-menu-wrapper kt-grid__item kt-grid__item--fluid" id="kt_aside_menu_wrapper">
                    <div id="kt_aside_menu" class="kt-aside-menu  kt-aside-menu--dropdown " data-ktmenu-vertical="1"
                        ...
                        <ul class="kt-menu__nav ">
                            ...
                            <li class="kt-menu__item  kt-menu__item--submenu" aria-haspopup="true"
                                data-ktmenu-submenu-toggle="click"><a href="javascript:;"
                                    class="kt-menu__link kt-menu__toggle"><i
                                        class="kt-menu__link-icon flaticon2-paper"></i><span
                            ...
                            <li class="kt-menu__item  kt-menu__item--submenu" aria-haspopup="true"
                                data-ktmenu-submenu-toggle="click"><a href="javascript:;"
                                    class="kt-menu__link kt-menu__toggle"><i class="fas fa-folder-open"></i><span
                                ...
                                <div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
                                    <ul class="kt-menu__subnav">
                                        <li class="kt-menu__item  kt-menu__item--parent" aria-haspopup="true"><span
                                                class="kt-menu__link"><span
                                                    class="kt-menu__link-text">Tugas</span></span>
                                        </li>
                                        <li class="kt-menu__item " aria-haspopup="true"><a
                                        ...
                                        <li class="kt-menu__item " aria-haspopup="true"><a
                                                href="<?=base_url('guru/data_tugas')?>" class="kt-menu__link "><i
                                                    class="kt-menu__link-icon la la-commenting"></i><span
                                                    class="kt-menu__link-text">Data Tugas</span></a></li>
                        ...
                        <div id="kt_header_menu" class="kt-header-menu kt-header-menu-mobile  kt-header-menu--layout- ">
                            <ul class="kt-menu__nav ">
                                ...
                                <li class="kt-menu__item  kt-menu__item--submenu kt-menu__item--rel"
                                    data-ktmenu-submenu-toggle="click" aria-haspopup="true"><a href="javascript:;"
                                        class="kt-menu__link kt-menu__toggle"><span
                                            class="kt-menu__link-text">Materi</span>
                                        <i class="kt-menu__hor-arrow la la-angle-down"></i></a>
                                ...
                                <li class="kt-menu__item  kt-menu__item--submenu kt-menu__item--rel"
                                    data-ktmenu-submenu-toggle="click" aria-haspopup="true"><a href="javascript:;"
                                        class="kt-menu__link kt-menu__toggle"><span
                                            class="kt-menu__link-text">Tugas</span>
                                        <i class="kt-menu__hor-arrow la la-angle-down"></i></a>
                                    <div class="kt-menu__submenu kt-menu__submenu--classic kt-menu__submenu--left">
                                        <ul class="kt-menu__subnav">
                                            <li class="kt-menu__item " aria-haspopup="true"><a
...
?>
                                ...
                                <div class="kt-notification">
                                    ...
                                    <a href="<?=base_url('guru/add_tugas')?>" class="kt-notification__item">
                                        <div class="kt-notification__item-icon">
                                            <i class="flaticon2-hourglass kt-font-brand"></i>
                                        </div>
                                        <div class="kt-notification__item-details">
...
?> !
                                            ...
                                            <div class="kt-widget19__labels">
                                                <a href="#" class="btn btn-label-light-o2 btn-bold btn-sm ">E-Learning
                                                    Pens</a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="kt-portlet__body">
                                        <div class="kt-widget19__wrapper">
                                            <div class="kt-widget19__content">
                                                ...
                                                <div class="kt-widget19__info">
                                                    <a href="<?=base_url('guru/data_materi')?>"
                                                        class="kt-widget19__username font-weight-bold">
                                                        Administrator
                                                    </a>
                                            ...
                                            <div class="kt-widget19__text">
                                                Selamat datang di halaman guru E-Learning Pens, anda dapat menambah
                                                materi .
                                                Dalam materi anda dapat memasukan video, dan deskripsi nya. Semoga anda
                                                dapat menikmati E-Learning Pens!, kontak Administrator jika terjadi
                                                masalah
                                        ...
                                        <div class="kt-widget19__action">
                                            <a href="<?=base_url('guru/add_materi')?>"
                                                class="btn btn-sm btn-label-brand btn-bold">Tambah Materi</a>
                                            <a href="<?=base_url('guru/data_materi')?>"
                                                class="btn btn-sm btn-label-brand btn-bold">Data Materi</a>
                                        </div><br>
                                        <br>
                                        <div class="kt-widget19__wrapper">
                                            <div class="kt-widget19__content">
                                                ...
                                                <div class="kt-widget19__info">
                                                    <a href="<?=base_url('guru/data_tugas')?>"
                                                        class="kt-widget19__username font-weight-bold">
                                                        Administrator
                                                    </a>
                                            ...
                                            <div class="kt-widget19__text">
                                                Selamat datang di halaman guru E-Learning Pens, anda dapat menambah
                                                tugas.
                                                Dalam tugas anda dapat memasukan file, dan deskripsi nya. Semoga anda
                                                dapat menikmati E-Learning Pens!, kontak Administrator jika terjadi
                                                masalah
                                                apapun yang terkait upload materi. Terima kasih telah menggunakan
                                                E-Learning Pens!
                                        ...
                                        <div class="kt-widget19__action">
                                            <a href="<?=base_url('guru/add_tugas')?>"
                                                class="btn btn-sm btn-label-brand btn-bold">Tambah Tugas</a>
                                            <a href="<?=base_url('guru/data_tugas')?>"
                                                class="btn btn-sm btn-label-brand btn-bold">Data Tugas</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="kt-footer kt-grid__item kt-grid kt-grid--desktop kt-grid--ver-desktop">
                        <div class="kt-footer__copyright">
                            2020&nbsp;&copy;&nbsp;<a href="https://github.com/zaidabdillah18/" target="_blank"
                                class="kt-link">Muhammad Zaid Abdillah</a>
                        </div>
                        <div class="kt-footer__menu">
                            Made with &nbsp; <span class="" style="color: red"> &#10084;</span> &nbsp; by Muhammad Zaid
                            Abdillah
                        </div>
                    </div>
                    <!-- end:: Footer -->
