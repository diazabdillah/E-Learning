...
<body style="overflow-x:hidden;background-color:#fbf9fa">
            ...
            <div class="row" style="color: black; font-family: 'poppins';">
                <div class="col-md-12 mt-1 ml-4">
                    <h1 class="display-4" style="color: black; font-family:'poppins';" data-aos="fade-down"
                        data-aos-duration="1400">Selamat Menonton Video Materi ! </h1>
                    ...
                    <p> <b>Judul Materi :</b> <?=$detail->judul?></p>
                    <b>
                        <p style="line-height: 10px;">Deskripsi Materi:
                    </b> <?= substr($detail->deskripsi, 0, 120); ?></p>
                </div>
            </div>
        </div>
    </div>
    ...
    <br>
    <div class="container">
        <div class="bg-blue mx-auto p-4 buat-text" data-aos="fade-left" data-aos-duration="1400"
            style="width: 100%; border-radius:10px;">
            <div class="row" style="color: black; font-family: 'poppins';">
                <div class="col-md-12 mt-1 ml-4">
                    <h1 class="display-4" style="color: black; font-family:'poppins';" data-aos="fade-left"
                        data-aos-duration="1400">File Materi Pembelajaran ! </h1>

                    <hr style="background-color: white;">
                    <h5 data-aos="fade-left" data-aos-duration="1400"><img style="width:100px;"
                            src="<?= base_url() . 'assets/img/file.jpg'?>" alt="file kosong"><a
                            href="<?=base_url().'assets/materi_video/'.$detail->video;?>"
                            target="_blank"><?=''.$detail->video;?></a></h5>
