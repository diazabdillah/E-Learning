...
<body style="overflow-x:hidden;background-color:#fbf9fa">
            ...
            <div class="row" style="color: black; font-family: 'poppins';">
                <div class="col-md-12 mt-1 text-center">
                    ...
                    <h4 data-aos="fade-down" data-aos-duration="1700"><?php
                        ...
                        <h5 data-aos="fade-down" data-aos-duration="1700">Home > Semester 1 ></h5>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="bg-white mx-auto p-4 buat-text" data-aos="fade-down" data-aos-duration="1400"
            style="width: 100%; border-radius:10px;">
            <h1 data-aos="fade-right" class="font-weight-bold" data-aos-duration="1800">Silahkan pilih MataKuliah
                dibawah ini:</h1>
            <div class="row mt-4 mb-5">
                <div class="col-md-4 mb-2 d-flex justify-content-center" data-aos-duration="1900" data-aos="fade-right">
                    <a href="<?= base_url('materi/orkom') ?>">
                        <div class="card-kelas">
                            <img src="<?= base_url('assets/') ?>img/orkom.png" class="card-img-top" alt="...">
                        </div>
                    </a>
                </div>
                <div class="col-md-4 mb-2 d-flex justify-content-center" data-aos-duration="1900" data-aos="fade-down">
                    <a href="<?= base_url('materi/basisdata') ?>">
                        <div class="card-kelas">
                            <img src="<?= base_url('assets/') ?>img/courses/gambar1.jpg" class="card-img-top" alt="...">
                        </div>
                    </a>
                </div>
                <div class="col-md-4 mb-2 d-flex justify-content-center" data-aos-duration="1900" data-aos="fade-left">
                    <a href="<?= base_url('materi/logikaalgoritma') ?>">
                        <div class="card-kelas">
                            <img src="<?= base_url('assets/') ?>img/courses/gambar2.jpg" class="card-img-top" alt="...">
                        </div>
                    </a>
                </div>
                ...
                <div class="col-md-4 mb-2 d-flex justify-content-center" data-aos-duration="1900" data-aos="fade-right">
                    <a href="<?= base_url('materi/matematikadiskrit') ?>">
                        <div class="card-kelas">
                            <img src="<?= base_url('assets/') ?>img/courses/gambar4.jpg" class="card-img-top" alt="...">
                        </div>
                    </a>
                </div>
                <div class="col-md-4 mb-2 d-flex justify-content-center" data-aos-duration="1900" data-aos="fade-down">
                    <a href="<?= base_url('materi/konseppemograman') ?>">
                        <div class="card-kelas">
                            <img src="<?= base_url('assets/') ?>img/courses/gambar5.jpg" class="card-img-top" alt="...">
                        </div>
                    </a>
                </div>
                <div class="col-md-4 mb-2 d-flex justify-content-center" data-aos-duration="1900" data-aos="fade-left">
