                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="nav-item dropdown ">
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="nav-link" href="<?= base_url('admin/data_siswa') ?>">Data Mahasiswa</a>
                                </li>
                            </ul>
                        </li>
                ...
                <section class="section">
                    <div class="card" style="width:100%;">
                        <div class="card-body">
                            ...
                            <hr>
                            <a href="<?= base_url('admin/tambah_tugas') ?>" class="btn btn-success">Tambah
                                Data Tugas</a>
                        </div>
                    </div>
                    <div class="row">
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="text-center">
                                                ...
                                                <td class="text-center">
                                                    <a href="<?php echo site_url('admin/update_tugas/' . $tugas->id); ?>"
                                                        class="btn btn-info">Update ⭢</a>

                                                    <a href="<?php echo site_url('admin/delete_tugas/' . $tugas->id); ?>"
    ...
    <footer class="main-footer">
        <div class="text-center">
            Copyright &copy; 2020 <div class="bullet"></div> <a
                href="https://github.com/zaidabdillah18">Zaidabdillah</a>
        </div>
    </footer>
    <!-- End Footer -->
