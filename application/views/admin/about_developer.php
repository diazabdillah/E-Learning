                ...
                <section class="section">
                    ...
                    <div class="">
                        <div class="card" style="width:100%;">
                            <div class="card-body">
                                <h2 class="card-title" style="color: black;">Muhammad Zaid Abdillah</h2>
                                <hr>
                            ...
                            <table style="width: 100%" class="container">
                                <tbody>
                                    <tr style="border-bottom: 0.5px solid #6c757d;">
                                        <td><span class="font-weight-bold">Kelas:</td>
                                        <td>2 D4 Informatika </td>
                                    </tr>
                                    <tr style="border-bottom: 0.5px solid #6c757d;">
                                        <td><span class="font-weight-bold">Jurusan:</td>
                                        <td>Informatika</td>
                                    </tr>
                                    <tr style="border-bottom: 0.5px solid #6c757d;">
                                        <td><span class="font-weight-bold">No Telephone:</td>
                                        <td>081331913558</td>
                                    </tr>
                                    <tr style="border-bottom: 0.5px solid #6c757d;">
                                    ...
                                    <tr style="border-bottom: 0.5px solid #6c757d;">
                                        <td><span class="font-weight-bold">Tempat Tinggal: </span></td>
                                        <td>Sukolilo dian regency 1 damai 2 no 6</td>
                                    </tr>
                                    <tr style="border-bottom: 0.5px solid #6c757d;">
                                        <td><span class="font-weight-bold">Perkerjaan:</span></td>
                                        <td>Mahasiswa</td>
                                    </tr>
