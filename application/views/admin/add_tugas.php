...
<head>
    ...
    <title>Tambah Data Tugas - E-Pens </title>
    <!-- General CSS Files -->
    ...
    <div id="app">
                ...
                <ul class="navbar-nav navbar-right">
                    <li class="dropdown"><a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            <div class="dropdown-title">Admin - E-Pens</div>
                    ...
                    <div class="">
                        ...
                        <div class="card card-success">
                            ...
                            <div id="detail" class="card-body">
                                <form method="POST" enctype="multipart/form-data" action="<?= base_url('admin/tambah_tugas') ?>">
                                            ...
                                            <div class="form-group">
                                                <div class="input-group">
                                                    <div class="custom-file">
                                                        ...
                                                        <label class="custom-file-label" for="inputGroupFile01">Upload Tugas Disini</label>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                        <label for="exampleFormControlTextarea1">Judul Tugas</label>
                                        <input type="text"class="form-control" required name="judul"id="judul" placeholder="silahkan masukan judul materi" rows="3"></input>
                                        </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                        <label for="exampleFormControlTextarea1">Tanggal Pengumpulan Tugas</label>
                                        <input type="date"class="form-control" required name="tanggal_kumpul"id="tanggal_kumpul"  rows="3"></input>
                                        </div>
                                        <div class="form-group">
                                        <label for="exampleFormControlTextarea1">Tanggal Pembuatan Tugas</label>
                                        <input type="date"class="form-control" required name="tanggal_buat"id="tanggal_buat"  rows="3"></input>
                                        </div>
                                            <div class="form-group">
        ...
        <footer class="main-footer">
            <div class="text-center">
                Copyright &copy; 2020 <div class="bullet"></div><a href="https://github.com/zaidabdillah18">zaidabdillah</a>
            </div>
        </footer>
        <!-- End Footer -->
