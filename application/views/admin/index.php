...
<head>
    ...
    <title>Admin Dashboard - E-Pens</title>
    <!-- General CSS Files -->
        ...
        <div class="main-wrapper">
                ...
                <ul class="navbar-nav navbar-right">
                    <li class="dropdown"><a href="#" data-toggle="dropdown"
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            ...
                            <a href="<?= base_url('welcome/admin/logout') ?>"
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                            <div class="card card-statistic-1">
                                ...
                                <div class="card-wrap">
                                    ...
                                    <div class="card-body">
                                        <?php echo $this->db->count_all('tugas'); ?>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card" style="width:100%;">
                            <div class="card-body">
                                ...
                                <p class="card-text">After I ran into Helen at a restaurant, I realized she was just
                                    ...
                                    request? but moving the goalposts gain traction.</p>
                        ...
                        <div class="hero text-white hero-bg-image"
                            ...
                            <div class=" hero-inner">
                                <h1>Selamat Datang, <?php
                                                    ...
                                                    echo $data['user']['username'];
                                                    ?>!</h1>
                                <p class="lead">After I ran into Helen at a restaurant, I realized she was just office
                                    pretty drop-dead date put in in a deck for our standup today. Who's responsible for
                                    the ask for this request? but moving the goalposts gain traction.</p>
                                <div class="mt-4">
            ...
            <footer class="main-footer">
                <div class="text-center">
                    Copyright &copy; 2020 <div class="bullet"></div><a href="">Zaidabdillah</a>
                </div>
            </footer>
            <!-- End Footer -->
